...
| [nlpm](https://github.com/xiaolai/nlpm-for-claude) | NLPM — scan, score, check, fix, test, security-scan, and trend-track NL artifacts via focused agents and the 50 Rules; v0.8.0+ adds a standalone Python validator for pre-commit / CI that catches manifest-vs-disk inconsistency (the bug class no other ecosystem tool checks) | 0.8.1 |
