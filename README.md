...
| [coding-discipline](https://github.com/chipfighter/coding-discipline) | Workflow-agnostic engineering guardrails — spec-sync preserves confirmed intent across sessions; risk-triggered skills enforce TDD, root-cause debugging, prioritized review, and evidence-before-done; quiet on routine work | 0.8.1 |
