...
| [tdd-guardian](https://github.com/xiaolai/tdd-guardian-for-claude) | TDD Guardian — per-lane gates (unit/integration/e2e/contract), spec-strength S1-S6, adversarial spec review, red receipts, per-path critical thresholds, 9-format coverage merging | 0.9.0 |
